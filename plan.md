...
- CI-ul ruleaza unit tests cu coverage, build si e2e, apoi publica un summary cu rezultatele si eventualele failures in GitHub Actions si ca sticky comment pe PR.
